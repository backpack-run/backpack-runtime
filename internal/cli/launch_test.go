...
func TestLaunchListAndHelp(t *testing.T) {
	...
	if !strings.Contains(output.String(), "Claude Code") || !strings.Contains(output.String(), "Codex CLI") || !strings.Contains(output.String(), "Codex App") || !strings.Contains(output.String(), "OpenCode") {
